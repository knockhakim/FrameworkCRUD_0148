        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10">
                <x-form-card>
                    ...
                    <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST" class="row" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="flex flex-wrap">
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <x-text-input id="nim" name="nim" type="text" class="mt-1 block w-full" value="{{ $mahasiswa->nim }}" />
                                    @error('nim')
                            ...
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <x-text-input id="nama" name="nama" type="text" class="mt-1 block w-full" value="{{ $mahasiswa->nama }}" />
                                    @error('nama')
                                    <p class="mt-2 text-sm text-red-600 space-y-1">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <x-text-input id="umur" name="umur" type="number" class="mt-1 block w-full" value="{{ $mahasiswa->umur }}" />
                                    @error('umur')
                                    <p class="mt-2 text-sm text-red-600 space-y-1">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="w-full lg:w-3/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <x-text-input id="jurusan" name="jurusan" type="text" class="mt-1 block w-full" value="{{ $mahasiswa->jurusan }}" />
                                    @error('jurusan')
                                    <p class="mt-2 text-sm text-red-600 space-y-1">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="w-full lg:w-3/12 px-4">
                                <div class="relative w-full mb-3">
                                    <div class="relative w-full mb-3">
                                        ...
                                        <x-text-input id="kota" name="kota" type="text" class="mt-1 block w-full" value="{{ $mahasiswa->kota }}" />
                                        @error('kota')
                                        <p class="mt-2 text-sm text-red-600 space-y-1">{{ $message }}</p>
                                        @enderror
                                    </div>
                        ...
                        <div class="flex flex-wrap">
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <x-text-input id="alamat" name="alamat" type="text" class="mt-1 block w-full" value="{{ $mahasiswa->alamat }}" />
                                    @error('alamat')
                                    <p class="mt-2 text-sm text-red-600 space-y-1">{{ $message }}</p>
                                    @enderror
                                </div>
